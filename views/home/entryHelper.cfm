                        ...
                        '<table border="0" cellpadding="0" cellspacing="0" width="100%">',
                            '<tr>',
                                '<td>',
                                    ...
                                    '<input type="text" class="form-control" name="fiddle_height" value="#prc.settings.height#" />',
                                    '<label>Width</label>',
                                    '<input type="text" class="form-control" name="fiddle_width" value="#prc.settings.width#" />',
                                '</td>',
                            '</tr>',
                            '<tr>',
                                '<td colspan="2">',
                                    ...
                                    '</label></div>',                                    
                                    '<div class="checkbox"><label>',
                                    '<input type="checkbox" name="fiddle_tabs" value="resources" <cfif listContains( prc.settings.tabs, "resources" )>checked=true</cfif> /> Resources',
                                    '</label></div>',                                    
                                    '<div class="checkbox"><label>',
                                    '<input type="checkbox" name="fiddle_tabs" value="css" <cfif listContains( prc.settings.tabs, "css" )>checked=true</cfif> /> CSS',
                                    '</label></div>',                                    
                                    '<div class="checkbox"><label>',
                                    '<input type="checkbox" name="fiddle_tabs" value="html" <cfif listContains( prc.settings.tabs, "html" )>checked=true</cfif> /> HTML',
                                    '</label></div>',
                                '</td>',
                            '</tr>',
                        '</table>',
